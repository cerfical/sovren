...
namespace sovren::rhi::dx {
    DxRenderTarget::DxRenderTarget(IDXGISurface* renderSurface, ID2D1DeviceContext* d2dContext) {
        ...
        comCheck(d2dContext->CreateBitmapFromDxgiSurface(renderSurface, D2D1::BitmapProperties1(D2D1_BITMAP_OPTIONS_TARGET | D2D1_BITMAP_OPTIONS_CANNOT_DRAW, D2D1::PixelFormat(DXGI_FORMAT_UNKNOWN, D2D1_ALPHA_MODE_IGNORE), 0.0f, 0.0f), &d2dRenderBitmap));
